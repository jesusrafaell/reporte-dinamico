...
import { getGeneralKeys } from '../../services/contabilidad';
...
const General: FC<Props> = () => {
	...
	return (
		<>
			...
			<div className={classesRD.cards}>
				<TableReports initDate={initDate} endDate={endDate} state={state} from='GeneralCont' />
			</div>
			{/* </div> */}
		</>
	);
